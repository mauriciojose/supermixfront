...
function SubCategorias(props) {
    ...
    const headers = ["Nome", "Categoria", "Data de Criação"];
    const incluir = ["nome", "cat_nome","created_at"];
    ...
    return (
      <>
        ...
        <div className="content">
          <Row>
            <Col xs="12">
                <Tables title="SubCategorias" headers={headers} incluir={incluir} datas={datas} bodys={subcategorias} button_title="Cadastrar SubCategoria" location="subcategorias">
                </Tables>
            </Col>
        </Row> 
      </div>
